...
class CarCamera():
    def __init__(self, flip_method=0):
        ...
        self.cap = cv2.VideoCapture(self.gstreamer_pipeline(
            capture_width=640, capture_height=368, display_width=640, display_height=368, framerate=30,
    ...
    def gstreamer_pipeline(self, capture_width=3280, capture_height=2464, display_width=820, display_height=616,
